// LOCAL auth for the test build (no Azure). Email + password, scrypt-hashed.
// Auth establishes IDENTITY ONLY. It does not unlock the vault (that's the
// separate vault password, zero-knowledge). Swap this file for auth.entra.js
// to move to Entra ID later — same exports, same session shape.
